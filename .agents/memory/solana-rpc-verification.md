...
**How to apply:** Keep verification fail-closed, batch requests when possible, bound scan duration, expose rejection reasons in system state, and use a reliable configured RPC source for production-scale scanning.