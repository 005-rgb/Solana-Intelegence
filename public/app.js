...
function go(page) { activePage = page; window.location.hash = page; render(); }
...
setInterval(() => {
  if (activePage === "dashboard") refresh().catch(() => {});
}, 30000);